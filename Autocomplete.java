...
public class Autocomplete {
    ...
    public double weightOf(String term) {
        Double getval = newtst.getweight(term);
        if (getval == null) {
            return 0.0;
        } else {
            return getval;
    ...
    public String topMatch(String prefix) {
        Iterator<String> catchIterator = topMatches(prefix, 1).iterator();
        if (catchIterator.hasNext()) {
            return catchIterator.next();
        } else {
            return null;
        }
    }
    ...
    public Iterable<String> topMatches(String prefix, int k) {
        ...
        return newtst.keysWithPrefix(prefix, k);
